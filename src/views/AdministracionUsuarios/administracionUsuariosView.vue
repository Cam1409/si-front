        ...
        <v-container class="cont2">
            ...
            <v-container class="contenedorP">
                ...
                <v-row class="conten">
                    ...
                    <v-combobox
                        ...
                        prepend-icon="mdi mdi-account-group mdi-48px"
                    ...
                    <v-text-field
                        ...
                        prepend-icon="mdi mdi-account-edit mdi-48px"
                        variant="outlined"
                        required
                    ></v-text-field>
                    </v-col>
                    ...
                    <v-text-field
                        ...
                        prepend-icon="mdi mdi-lock-check mdi-48px"
                        variant="outlined"
                        required
                    ></v-text-field>
                    </v-col>
            ...
            <v-table class="tabla-docentes">
                ...
                <template v-for="(profesor, index) in paginatedProfesores" :key="index">
                    ...
                    <td class="c6">
                        <v-icon class="mdi mdi-delete-empty"  @click="handleIconClick(profesor.p_codigoD)"></v-icon>
                    </td>
                    </tr>
                </template>
                </tbody>
